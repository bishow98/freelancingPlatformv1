...
const JobDescription = () => {
  ...
  const isInitiallyApplied =
    ...
    ) || false; //freelancer le jaba details click garxa taba yedi tyo user login xa vaney first time ko lagi apply now button enable gardinxa
  ...
  return (
    <div className="max-w-7xl mx-auto my-10">
      ...
      <div>
        ...
        <h1 className="font-bold my-1">
          Requirements:
           <span className="pl-4 font-normal text-gray-800"> <span className="gap-2">{singleJob?.requirements?.map((item,index)=><Badge className="" key={index}>{item}</Badge>)}</span></span>
